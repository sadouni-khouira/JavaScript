...
Créer un chronomètre composé d'un afficheur et 3 boutons : un bouton "start" pour lancer le chronomètre, un bouton "stop" pour
 l'arrêter et un bouton "reset" pour le remettre à zéro.
