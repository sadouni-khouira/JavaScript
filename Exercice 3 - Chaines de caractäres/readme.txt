...
# Travail à faire
1) Ecrire une fonction qui permet de tester si une chaîne de caractère 
passée en paramètre commence par une lettre majuscule ou minuscule
 positionnée entre 'a' et 'd'.
2) Ecrire une fonction qui renvoie true lorsqu'une chaîne contient un seul caractère '@' sinon renvoie false.
3) Ecrire une fonction qui renvoie true lorsqu'une chaîne contient au moins
 un chiffre sinon renvoie false.
